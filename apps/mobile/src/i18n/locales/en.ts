const en = {
  ...
  screens: {
    ...
    movies: {
      ...
      tabAnime: "Anime",
      emptyAnime: "No anime",
      addFromSearchAnime: "No anime… Even Goku hasn't sensed any power level here.",
      addBtnAnime: "Add an anime",
    },
    library: {
    ...
    profile: {
      ...
      aboutLinkTerms: "Terms of Service",
      aboutLinkContact: "Contact us",
      ...
      apiKeysScopesRequired: "Please select at least one scope.",
      apiKeysScopeRead: "Read",
      apiKeysScopeWrite: "Write",
      ...
      apiKeysTipsTitle: "Security tips",
      apiKeysTipSecurity: "Never share your API keys. Store them securely — treat them like passwords.",
      apiKeysTipRateLimit: "Rate limits: 60 req/min for read operations, 20 req/min for write operations.",
      apiKeysTipScopes: "Use the narrowest scope possible. Prefer 'read' unless you need to modify your watchlist.",
      apiKeysQuickGuideTitle: "Quick start",
      apiKeysQuickGuideStep1: "Create a key with the scopes you need.",
      apiKeysQuickGuideStep2: "Pass it in the Authorization header as a Bearer token.",
      apiKeysQuickGuideExample: "Authorization: Bearer wtc_your_api_key",
      apiKeysLinksTitle: "Documentation",
      apiKeysLinkDocs: "API documentation",
      apiKeysLinkAuth: "Authentication guide",
    ...
    import: {
      ...
      traktConnectedSuccess: "Trakt account connected successfully",
      traktConnectError: "Failed to connect Trakt: {{error}}",
      ...
      jsonBadge: "JSON",
      csvBadge: "CSV",
      helpTitle: "Help & formats",
      helpTvTime: "TV Time: Download your GDPR export from TV Time settings. Upload the .zip file. Supports both CSV and JSON formats.",
      helpTrakt: "Trakt: Export your data from Trakt settings as JSON. Upload the file to import your watched history, ratings and watchlist.",
      helpImdb: "IMDb: Export your ratings/watchlist from IMDb settings as CSV. Both old and new column formats are supported.",
      helpLetterboxd: "Letterboxd: Export your diary from Letterboxd settings. Upload diary.csv, ratings.csv, watched.csv or watchlist.csv.",
    },
    importReview: {
    ...
    export: {
      ...
      moviesOnlyBadge: "Movies only",
      helpTitle: "Help & formats",
      helpJson: "Watchr JSON: Complete backup with all data including watched episodes, ratings and status. Best for restoring your account.",
      helpCsv: "Watchr CSV: Generic spreadsheet format with your tracking data. Can be opened in Excel or Google Sheets.",
      helpTrakt: "Trakt JSON: Compatible with Trakt import. Includes watched episodes, ratings and watchlist with TMDB and IMDb IDs.",
      helpImdb: "IMDb CSV: Compatible with IMDb ratings import. Includes Const, URL, ratings and dates.",
      helpLetterboxd: "Letterboxd CSV: Compatible with Letterboxd diary import. Movies only, with ratings on 0.5-5 scale.",
    },
    upcoming: {
      today: "Today",
      tomorrow: "Tomorrow",
    ...
    subscription: {
      ...
      cancelConfirm: "Are you sure you want to cancel your VIP subscription?",
      cancelled: "Subscription cancelled successfully.",
      active: "VIP Active",
      activeMessage: "Thank you for supporting Watchr!",
      successTitle: "Subscription activated!",
      successMessage: "Your VIP subscription is now active.",
      ...
      nativeRedirectNotice: "You will be redirected to our website to complete payment securely.",
      mcpQuotaTitle: "MCP Daily Quota",
      mcpQuotaRemaining: "{{remaining}} / {{limit}} requests remaining today",
      mcpQuotaUnlimited: "Unlimited requests (VIP)",
  ...
  messages: {
    ...
    noConversationsDesc: "Start a conversation with a friend!",
    ...
    deleteConfirmDesc: "This message will be permanently deleted.",
    cancel: "Cancel",
    confirm: "Confirm",
    report: "Report",
    ...
    dmNotAllowed: "This user only accepts messages from friends",
