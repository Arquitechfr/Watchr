const tr = {
  ...
  screens: {
    ...
    profile: {
      ...
      apiKeysTipsTitle: "Güvenlik ipuçları",
      apiKeysTipSecurity: "API anahtarlarınızı asla paylaşma. Onları güvenli bir şekilde depolayın - onları şifre gibi davran.",
      apiKeysTipRateLimit: "Hesaplama limitleri: 60 req/min for read operations, 20 req/min for write operations.",
      apiKeysTipScopes: "Mümkün olan en dar kapsamı kullanın. İzleme listelerinizi değiştirmeniz gerekmediği sürece \"oku\" tercih edin.",
      apiKeysQuickGuideTitle: "Hızlı başlangıç",
      apiKeysQuickGuideStep1: "İhtiyacınız olan kapsamlarla bir anahtar oluşturun.",
      apiKeysQuickGuideStep2: "Bir Ayıer token olarak kayıt altına alın.",
      apiKeysQuickGuideExample: "Authorization: Bearer wtc_your_api_key",
      apiKeysLinksTitle: "Dokümantasyon",
      apiKeysLinkDocs: "API belgeleri",
      apiKeysLinkAuth: "Doğrulama rehberi",
      apiKeysLinkMcp: "MCP server kurulumu",
      apiKeysLinkEndpoints: "API endpoints",
      apiKeysEmptyCta: "Read the docs",
      library: "Kütüphanem",
      myData: "Verilerim",
      subscription: "Abonelik Aboneliği",
      upgradeVip: "VIP'ye Yükseltin",
    ...
    import: {
      ...
      traktConnectedSuccess: "Trakt Hesap bağlantısı başarıyla başarıyla başarıyla",
      traktConnectError: "Bağlanmak için başarısız oldu Trakt: {{error}}",
      ...
      jsonBadge: "JSON",
      csvBadge: "CSV",
      helpTitle: "Yardım ve formatlar",
      helpTvTime: "TV Time: GDPR ihracatınızı GDPR ihracatınızı indirin TV Time ayarlar. .zip dosyasını yükleyin. Hem CSV hem de JSON formatlarını destekler.",
      helpTrakt: "Trakt: verilerinizi sizden ihracat Trakt JSON olarak ayarlar. İzleme Tarihinizi, puanlarınızı ve saat listelerinizi ithal etmek için dosyayı yükleyin.",
      helpImdb: "IMDb: Puanlarınızı / saat listelerinizi ihracat IMDb CSV olarak ayarlar. Hem eski hem de yeni sütun biçimleri desteklenmektedir.",
      helpLetterboxd: "Letterboxd: Günlüğünüzü günden itibaren ihracat Letterboxd ayarlar. Yükleme günlüğü.csv, puanlar.csv, izledi.csv veya watchlist.csv.",
    },
    importReview: {
    ...
    export: {
      ...
      options: "İhracat seçenekleri",
      includeRatings: "Add ratings",
      includeWatchlist: "Add watchlist",
      fullBackupBadge: "Full backup",
      compatibleBadge: "Uyumlu Uyumlu Uyumlu",
      moviesOnlyBadge: "Filmler Sadece Filmler",
      helpTitle: "Yardım ve formatlar",
      helpJson: "Watchr JSON: İzlenen bölümler, derecelendirmeler ve statü dahil tüm verilerle tam yedekleme. Hesabınızı restore etmek için en iyisi.",
      helpCsv: "Watchr CSV: Genric, takip verilerinizle tablo formatını yay. Excel'de veya Google Dokümanlar.",
      helpTrakt: "Trakt JSON: Uyumlu with Trakt ithalat. İzlenilen bölümler, derecelendirmeler ve saat listesi TMDB ve IMDb IDs.",
      helpImdb: "IMDb CSV: Uyumlu IMDb Puanlar ithalat. Const, URL, derecelendirme ve tarihler içerir.",
      helpLetterboxd: "Letterboxd CSV: Uyumlu Letterboxd Günlük ithalat. Filmler sadece 0,5-5 ölçeğinde puanlarla.",
    },
    upcoming: {
    ...
    subscription: {
      title: "Abonelik Aboneliği",
      vipFeatures: "VIP Özellikler",
      upgradeCta: "VIP'ye Yükseltin",
      monthlyPrice: "€3.99 / ay",
      cancelCta: "Cancel abonelik abonelik",
      cancelConfirm: "VIP aboneliklerinizi iptal etmek istediğinizden emin misiniz?",
      cancelled: "Abonelik başarıyla iptal etti.",
      active: "VIP Aktif VIP",
      activeMessage: "Teşekkür etmek için teşekkür ederiz Watchr!",
      successTitle: "Abone olun!",
      successMessage: "VIP aboneliğiniz şimdi aktif.",
      backToProfile: "Back to profile",
      featureNoAds: "Ad-free experience",
      featureAdvancedStats: "Gelişmiş istatistikler",
      featureUnlimitedTracking: "Sınırsız gösteri izleme izleme",
      featureAiInsights: "AI destekli anlayış",
      nativeRedirectNotice: "Web sitemize güvenli bir şekilde ödeme yapmak için yönlendirileceksiniz.",
      mcpQuotaTitle: "MCP Daily Quota",
      mcpQuotaRemaining: "{{remaining}} / {{limit}} Bugün kalan talepler",
      mcpQuotaUnlimited: "Sınırsız istekler (VIP)",
      mcpQuotaUpgrade: "Sınırsız MCP talepleri için VIP'ye Yükseltin",
      apiPlanLabel: "Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan Plan",
      apiPlanFree: "Ücretsiz",
      apiPlanVip: "VIP VIP VIP VIP",
    },
  },
  components: {
