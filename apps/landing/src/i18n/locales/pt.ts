  ...
  docs: {
    ...
    mcp: {
      ...
      tools: {
        ...
        "search_show.params.query": "A string de pesquisa (1-200 caracteres).",
        ...
        "list_watchlist.params.limit": "Itens por página (padrão: 20, máximo: 100).",
        add_to_watchlist: "Adicionar um programa ou filme à lista de vigilância por TMDB ID e tipo (tv ou filme).",
        "add_to_watchlist.params.tmdbId": "A TMDB Identificação do programa ou filme.",
        "add_to_watchlist.params.type": "O tipo de conteúdo: \"tv\" ou \"filme\".",
        ...
        "update_watch_status.params.showId": "O objeto do show.",
        "update_watch_status.params.status": "O novo status do relógio: observando, completado, plan to watch, ou deixado cair.",
        remove_from_watchlist: "Remover um show da lista de observação pelo seu Mostrar objetoId.",
        "remove_from_watchlist.params.showId": "O objeto do show.",
        toggle_episode: "Marque um episódio específico como assistido ou não.",
        "toggle_episode.params.showId": "O objeto do show.",
        "toggle_episode.params.season": "O número da temporada.",
        "toggle_episode.params.episode": "O número do episódio.",
        "toggle_episode.params.watched": "Marcar como vigiado (verdadeiro) ou não vigiado (falso).",
        mark_episodes_up_to: "Marque todos os episódios até uma temporada/episódio específico como observado.",
        "mark_episodes_up_to.params.showId": "O objeto do show.",
        "mark_episodes_up_to.params.season": "O número da temporada alvo.",
        "mark_episodes_up_to.params.episode": "O número do episódio alvo.",
        "mark_episodes_up_to.params.includePrevious": "Se deve marcar todos os episódios anteriores através das estações (padrão: true).",
        get_show_details: "Obter informações detalhadas sobre um show por TMDB ID, incluindo estações e episódios.",
        "get_show_details.params.tmdbId": "A TMDB Identificação do programa.",
        rate_show: "Rate um show ou episódio de 1 a 5 estrelas. Opcionalmente incluir um texto de revisão.",
        "rate_show.params.showId": "O objeto do show.",
        "rate_show.params.value": "O valor da notação de 1 a 5.",
        "rate_show.params.season": "Número de temporada opcional para avaliações específicas de episódios.",
        "rate_show.params.episode": "Número de episódio opcional para avaliações específicas de episódios.",
        "rate_show.params.review": "Texto opcional de revisão (máx. 2000 caracteres).",
        get_ratings: "Obtenha a classificação do usuário e as avaliações da comunidade para um show.",
        "get_ratings.params.showId": "O objeto do show.",
        list_comments: "Listar comentários públicos para um show, opcionalmente filtrado por episódio.",
        "list_comments.params.showId": "O objeto do show.",
        "list_comments.params.season": "Número de temporada opcional para filtrar comentários.",
        "list_comments.params.episode": "Número de episódio opcional para filtrar comentários.",
        "list_comments.params.page": "Número da página (padrão: 1).",
        "list_comments.params.limit": "Itens por página (padrão: 10, máx: 50).",
        "list_comments.params.sort": "Ordem de ordenação: recente, gostou, respondeu ou relevante (padrão: recente).",
        add_comment: "Publicar um comentário público sobre um show ou episódio.",
        "add_comment.params.showId": "O objeto do show.",
        "add_comment.params.content": "O texto do comentário (1-2000 caracteres).",
        "add_comment.params.season": "Número de temporada opcional para comentários de episódios.",
        "add_comment.params.episode": "Número de episódio opcional para comentários de episódio.",
        "add_comment.params.isSpoiler": "Se o comentário contém spoilers (padrão: false).",
